...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://hurricane-lynx-c85.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ORCHID', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '执行力！毅力！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-five-wheat-69.vercel.app/', // 网站地址
